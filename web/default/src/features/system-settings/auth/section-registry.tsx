    ...
    build: (settings: AuthSettings) => (
      <BasicAuthSection
        defaultValues={{
          ...
          EmailOTPRegisterEnabled: settings.EmailOTPRegisterEnabled,
          EmailOTPValidityMinutes: settings.EmailOTPValidityMinutes,
          EmailOTPMaxAttempts: settings.EmailOTPMaxAttempts,
          EmailOTPResendCooldownSeconds: settings.EmailOTPResendCooldownSeconds,
          EmailOTPHourlyLimit: settings.EmailOTPHourlyLimit,
